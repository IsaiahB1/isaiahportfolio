        ...
        <div className="c">
            ...
            <div className="c-wrapper">
                ...
                <div className="c-right">
                    <p className="c-desc">
                        <b>Any opportunities for Isaiah?</b> Feel free to contact him by the email given or by sending a message below.
                    </p>
